...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    UpdateTeacher() {
        ...
        id15 = new JLabel("Update Teacher Details :");
        ...
        t12 = new JTextField();
        t12.setBounds(600, 420, 150, 30);
        f.add(t12);

        lab2 = new JLabel("Education");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b) {
            try {
                Conn con = new Conn();
                String str = "update teacher set name='" + t1.getText() + "',fathers_name='" + t2.getText() + "',age='" + t3.getText() + "', dob='" + t4.getText() + "',address='" + t5.getText() + "',phone='" + t6.getText() + "',email='" + t7.getText() + "',class_xii='" + t8.getText() + "',class_x='" + t9.getText() + "',emp_id='" + t10.getText() + "', addhar = '" + t11.getText() + "',dept='" + t12.getText() + "', course='" + t13.getText() + "' where emp_id='" + t.getText() + "'";
        ...
        if (ae.getSource() == b2) {
            try {
                Conn con = new Conn();
                String str = "select * from teacher where emp_id = '" + t.getText() + "'";
