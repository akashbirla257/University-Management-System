...
public class Marks extends JFrame {
    ...
    public void mark(String st) {
        try {
            Conn c = new Conn();

            t1.setText("\tResult of Examination\n\nSubject\n");

            ResultSet rs1 = c.s.executeQuery("select * from subject where rollno=" + st);
            ...
            ResultSet rs2 = c.s.executeQuery("select * from marks where rollno=" + st);
