...
public class FeeStructure extends JFrame {
    ...
    FeeStructure() {
        ...
        bb1 = new JLabel("Rs 25000");
        bb1.setBounds(680, 170, 150, 40);
        bb1.setFont(new Font("serif", Font.PLAIN, 26));
        add(bb1);

        bb2 = new JLabel("Rs 25000");
        bb2.setBounds(680, 240, 150, 40);
        bb2.setFont(new Font("serif", Font.PLAIN, 26));
        add(bb2);

        bb3 = new JLabel("Rs 25000");
        bb3.setBounds(680, 310, 150, 40);
        bb3.setFont(new Font("serif", Font.PLAIN, 26));
        add(bb3);

        bb4 = new JLabel("Rs 25000");
        bb4.setBounds(680, 380, 150, 40);
        bb4.setFont(new Font("serif", Font.PLAIN, 26));
        add(bb4);

        bb5 = new JLabel("Rs 25000");
        bb5.setBounds(680, 450, 150, 40);
        bb5.setFont(new Font("serif", Font.PLAIN, 26));
        add(bb5);

        bb6 = new JLabel("Rs 25000");
        bb6.setBounds(680, 520, 150, 40);
        ...
        bb13 = new JLabel("Rs 32000");
        bb13.setBounds(480,170,100,40);
        bb13.setFont(new Font("serif",Font.PLAIN,26));
        add(bb13);
        
        bb14 = new JLabel("Rs 32000");
        bb14.setBounds(480,240,100,40);
        bb14.setFont(new Font("serif",Font.PLAIN,26));
        add(bb14);
        
        bb15 = new JLabel("Rs 32000");
        bb15.setBounds(480,310,100,40);
        bb15.setFont(new Font("serif",Font.PLAIN,26));
        add(bb15);
        
        bb16 = new JLabel("Rs 32000");
        bb16.setBounds(480,380,100,40);
