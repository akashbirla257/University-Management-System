...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        c1 = new Choice();
        c1.setForeground(new Color(89, 109, 79));
        ...
        combobox_1.setModel(new DefaultComboBoxModel(new String[]{"Mechanical", "CSE", "IT", "Civil", "Automobile", "Electronics", "Other"}));
        combobox_1.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
        combobox_1.setBounds(176, 211, 154, 20);
        contPane.add(combobox_1);
        ...
        contPane.setBackground(Color.LIGHT_GRAY);
