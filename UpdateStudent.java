...
public class UpdateStudent implements ActionListener {
    ...
    JLabel id, id1, id2, id3, id4, id5, id6, id7, id8, id9, id10, id11, id15, lab, lab2;
    ...
    UpdateStudent() {
        ...
        id15 = new JLabel("Update Student Details:");
        id15.setBounds(50, 10, 500, 50);
        id15.setFont(new Font("serif", Font.ITALIC, 40));
        ...
        id11.setBounds(50, 470, 150, 30);
        id11.setFont(new Font("serif", Font.BOLD, 20));
        f.add(id11);

        t11 = new JTextField();
        t11.setBounds(200, 470, 150, 30);
        f.add(t11);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b) {
            try {
                Conn con = new Conn();
                String str = "update student set name='" + t1.getText() + "',fathers_name='" + t2.getText() + "',dob='" + t3.getText() + "', age='" + t4.getText() + "',addhar='" + t5.getText() + "',email='" + t6.getText() + "',class_x='" + t7.getText() + "',class_xii='" + t8.getText() + "',phone='" + t9.getText() + ",course='" + t12.getText() + "',branch='" + t13.getText() + "',address='" + t11.getText() + "' where rollno='" + t.getText() + "'";
        ...
        if (ae.getSource() == b2) {
            try {
                Conn con = new Conn();
                String str = "select * from student where rollno = '" + t.getText() + "'";
